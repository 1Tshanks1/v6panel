...
class Ui_secondPage(object):
    def setupUi(self, secondPage):
        ...
        self.latitudeLabe = QLabel(secondPage)
        self.latitudeLabe.setObjectName(u"latitudeLabe")
        self.latitudeLabe.setGeometry(QRect(320, 120, 151, 61))
        self.latitudeLabe.setFont(font)
        self.setButton = QPushButton(secondPage)
        self.setButton.setObjectName(u"setButton")
        self.setButton.setGeometry(QRect(300, 360, 131, 41))
        self.setButton.setFont(font)
        self.backButton = QPushButton(secondPage)
        self.backButton.setObjectName(u"backButton")
        self.backButton.setGeometry(QRect(130, 410, 131, 41))
        self.backButton.setFont(font)
        self.nextButton = QPushButton(secondPage)
        self.nextButton.setObjectName(u"nextButton")
        self.nextButton.setGeometry(QRect(300, 410, 131, 41))
        self.nextButton.setFont(font)
        self.resButton = QPushButton(secondPage)
        self.resButton.setObjectName(u"resButton")
        self.resButton.setGeometry(QRect(130, 360, 131, 41))
    ...
    def retranslateUi(self, secondPage):
        ...
        self.resButton.setText(QCoreApplication.translate("secondPage", u"RESET", None))
    # retranslateUi
...
class Ui_secondthirdPage(object):
    def setupUi(self, secondPage):
        if not secondPage.objectName():
            secondPage.setObjectName(u"secondPage")
        secondPage.resize(960, 731)
        ...
        self.backButton = QPushButton(secondPage)
        self.backButton.setObjectName(u"backButton")
        self.backButton.setGeometry(QRect(380, 430, 131, 41))
        self.backButton.setFont(font)
        self.nextButton = QPushButton(secondPage)
        self.nextButton.setObjectName(u"nextButton")
        self.nextButton.setGeometry(QRect(620, 430, 131, 41))
        self.nextButton.setFont(font)
        self.resButton = QPushButton(secondPage)
        self.resButton.setObjectName(u"resButton")
        self.resButton.setGeometry(QRect(290, 360, 61, 41))
        ...
        self.resButton_2 = QPushButton(secondPage)
        self.resButton_2.setObjectName(u"resButton_2")
        self.resButton_2.setGeometry(QRect(500, 360, 61, 41))
        self.resButton_2.setFont(font)
        self.setButton_2 = QPushButton(secondPage)
        self.setButton_2.setObjectName(u"setButton_2")
        self.setButton_2.setGeometry(QRect(560, 360, 81, 41))
        self.setButton_2.setFont(font)
        self.devicename1 = QLabel(secondPage)
        self.devicename1.setObjectName(u"devicename1")
        self.devicename1.setGeometry(QRect(310, 50, 151, 61))
        ...
        self.devicename2.setGeometry(QRect(500, 50, 161, 61))
        self.devicename2.setFont(font)
        self.devicename3 = QLabel(secondPage)
        self.devicename3.setObjectName(u"devicename3")
        self.devicename3.setGeometry(QRect(730, 50, 161, 61))
        self.devicename3.setFont(font)
        self.velocityLabel_3 = QLabel(secondPage)
        self.velocityLabel_3.setObjectName(u"velocityLabel_3")
        self.velocityLabel_3.setGeometry(QRect(750, 300, 151, 61))
        self.velocityLabel_3.setFont(font)
        self.latitudeLabel_3 = QLabel(secondPage)
        self.latitudeLabel_3.setObjectName(u"latitudeLabel_3")
        self.latitudeLabel_3.setGeometry(QRect(750, 120, 151, 61))
        self.latitudeLabel_3.setFont(font)
        self.altitudeLabel_3 = QLabel(secondPage)
        self.altitudeLabel_3.setObjectName(u"altitudeLabel_3")
        self.altitudeLabel_3.setGeometry(QRect(750, 240, 151, 61))
        self.altitudeLabel_3.setFont(font)
        self.longtitudeLabel_3 = QLabel(secondPage)
        self.longtitudeLabel_3.setObjectName(u"longtitudeLabel_3")
        self.longtitudeLabel_3.setGeometry(QRect(750, 180, 151, 61))
        self.longtitudeLabel_3.setFont(font)
        self.resButton_3 = QPushButton(secondPage)
        self.resButton_3.setObjectName(u"resButton_3")
        self.resButton_3.setGeometry(QRect(730, 360, 61, 41))
        self.resButton_3.setFont(font)
        self.setButton_3 = QPushButton(secondPage)
        self.setButton_3.setObjectName(u"setButton_3")
        self.setButton_3.setGeometry(QRect(790, 360, 81, 41))
        self.setButton_3.setFont(font)
    ...
    def retranslateUi(self, secondPage):
        ...
        self.devicename1.setText(QCoreApplication.translate("secondPage", u"devicename1", None))
        self.devicename2.setText(QCoreApplication.translate("secondPage", u"devicename2", None))
        self.devicename3.setText(QCoreApplication.translate("secondPage", u"devicename3", None))
        self.velocityLabel_3.setText(QCoreApplication.translate("secondPage", u"Velocity", None))
        self.latitudeLabel_3.setText(QCoreApplication.translate("secondPage", u"Latitude", None))
        self.altitudeLabel_3.setText(QCoreApplication.translate("secondPage", u"Altitude", None))
        self.longtitudeLabel_3.setText(QCoreApplication.translate("secondPage", u"Longtitude", None))
        self.resButton_3.setText(QCoreApplication.translate("secondPage", u"RES", None))
        self.setButton_3.setText(QCoreApplication.translate("secondPage", u"SET", None))
    # retranslateUi
